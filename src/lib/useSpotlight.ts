...
// useSpotlight — portado do design system "Conversão Extrema" v2.1. Luz que
// acompanha o cursor sobre uma superfície.
//
// Publica a posição do ponteiro (relativa ao elemento) em --spot-x/--spot-y; o
// brilho em si é desenhado no CSS por `.premium-card::after`. Espalhe o retorno
// no elemento:
//
